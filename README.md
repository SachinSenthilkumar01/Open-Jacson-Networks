...
## Output
<img width="780" height="380" alt="image" src="https://github.com/user-attachments/assets/3fc633f5-b725-4099-85db-3139b0854b54" />

## Result
Hence we have found (a) average number of materials in the system (b) average number of materials in the each conveyor of (c) waiting time of each material in the system (d) waiting time of each material in each conveyor.
